...
import com.example.recipify.databinding.ActivityLoginGoogleBinding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        signInRequest = BeginSignInRequest.builder()
                .setGoogleIdTokenRequestOptions(BeginSignInRequest.GoogleIdTokenRequestOptions.builder()
                        ...
                        .setServerClientId("118274480399-g9rg3nkg3ohn29r15tahv2vijvu0vufh.apps.googleusercontent.com")
                ...
                oneTapClient.beginSignIn(signInRequest)
                        .addOnSuccessListener(GoogleLoginActivity.this, new OnSuccessListener<BeginSignInResult>() {
                            ...
                            public void onSuccess(BeginSignInResult result) {
                                try {
                                    ...
                                    Log.e("BeginSignInResult", "Couldn't start One Tap UI: " + e.getLocalizedMessage());
                                }
                            }
                        })
                        .addOnFailureListener(GoogleLoginActivity.this, new OnFailureListener() {
                            ...
                            public void onFailure(@NonNull Exception e) {
                                ...
                                Log.d("BeginSignInResult", e.getLocalizedMessage());
                            }
                        });
            }
        });
